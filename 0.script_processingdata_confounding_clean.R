...
data[-seq_along(files_idm)] <- 
  apply(data[-seq_along(files_idm)], data.table::setorder, idc)
...
saveRDS(imp, file.path(dir_imp, "imp30-30_010321.rds"))
